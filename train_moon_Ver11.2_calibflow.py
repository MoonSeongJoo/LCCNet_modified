...
from losses_Ver11_1_TaskAware import DistancePoints3D, GeometricLoss, L1Loss, ProposedLoss, CombinedLoss ,CustomTaskAwareLoss
...
def config():
    ...
    weights = './checkpoints/kitti/odom/val_seq_07/models/checkpoint_r20.00_t1.50_e89_247.424.tar'
    # weights = None
...
#     plt.axis('off'); 
    ...
    task_aware_loss = CustomTaskAwareLoss
