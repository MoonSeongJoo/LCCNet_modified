...
#         img_a_shape = img_a.shape[1:3]
#         img_b_shape = img_b.shape[1:3]
#         print ('------- corr_mutiscale function image a.shape ----------' , img_a.shape)
#         print ('------- corr_mutiscale function image b.shape ----------' , img_b.shape)
#         print ('------- corr_mutiscale function img_a_shape ----------' , img_a_shape)
#         print ('------- corr_mutiscale function img_b_shape ----------' , img_b_shape)
    ...
    def cotr_corr_multiscale_with_cycle_consistency(self, img_a, img_b, zoom_ins=[1.0], converge_iters=1, max_corrs=1000, queries_a=None, return_idx=False, return_cycle_error=False):
        ...
        corr_f, idx_f = self.cotr_corr_multiscale(img_a.copy(), img_b.copy(),
                                                  ...
                                                  queries_a=queries_a,
                                                  return_idx=True)
#         print ('=============corr_f.shape=================' , corr_f.shape)
#         print ('=============corr_f.value=================' , corr_f)
#         print ('=============idx_f.shape=================' , idx_f.shape)
        #print ('=============idx_f.value=================' , idx_f)
...
#         print ('=============corr_b.shape=================' , corr_b.shape)
#         print ('=============corr_b.value=================' , corr_b)
#         print ('=============idx_b.shape=================' , idx_b.shape)
#         print ('=============idx_b.value=================' , idx_b)
#         print('corr_f[idx_b][:, :2]====' ,corr_f[idx_b][:, :2])
#         print('corr_b[:, 2:]========' ,corr_b[:, 2:] )
#         if idx_b is None :
#             print ("idx_b is None!")
#             out = None
        if len(idx_b) > 0 :
