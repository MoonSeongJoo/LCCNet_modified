...
class CombinedLoss(nn.Module):
    def __init__(self, rescale_trans, rescale_rot , weight_point_cloud):
        ...
        self.weight_corr = 10.0
        self.weight_point_cloud = 0.01
        self.weight_rot = 0.1
        self.weight_trans = 10.0
        self.loss = {} 
...
#         return loss
    ...
    def forward(self, point_clouds, target_transl, target_rot, transl_err, rot_err , corr_target , corr_pred , queries , cycle , mask):
        """
