...
def config():
    ...
    data_folder = "/data/kitti/kitti_odometry"  # sapeon gpu server 1 
    use_reflectance = False
    val_sequence = 7
    epochs = 200
    BASE_LEARNING_RATE = 5e-6 # 1e-4
    loss = 'combined'
    ...
    weights = './checkpoints/kitti/odom/val_seq_07/models/checkpoint_r7.50_t0.20_e9_4678.415.tar'
    # weights = None
