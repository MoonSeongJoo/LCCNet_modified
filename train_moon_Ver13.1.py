...
from DatasetLidarCamera_Ver13_1 import DatasetLidarCameraKittiOdometry
from losses_Ver13_1 import DistancePoints3D, GeometricLoss, L1Loss, ProposedLoss, CombinedLoss
...
def config():
    ...
    # weights = './checkpoints/kitti/odom/val_seq_07/models/checkpoint_r10.00_t0.25_e64_1.247.tar'
    weights = None
