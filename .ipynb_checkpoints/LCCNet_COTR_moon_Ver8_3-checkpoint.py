...
#         plt.subplot(312)
#         plt.imshow(torchvision.utils.make_grid(rgb_pred_input).cpu().numpy() , cmap='magma')
#         plt.title("rgb_depth_pred", fontsize=22)
#         plt.axis('off')
        
#         plt.subplot(313)
#         plt.imshow(torchvision.utils.make_grid(depth_input).cpu().numpy() , cmap='magma')
...
#         plt.title("merged_cotr_input", fontsize=22)
#         plt.axis('off')
