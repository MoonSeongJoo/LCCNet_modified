...
#         pairwise_distance = -xx - inner - xx.transpose(4, 1)
        pairwise_distance = F.pairwise_distance(x,x)
...
#         print ('dense_depth_img_np_resized_shape = ' , dense_depth_img_np_resized.shape)
#         rgb_np_resized = rgb_np
#         depth_img_np_resized = depth_img_np
#         depth_gt_np_resized = depth_gt_np  
        ##### network input raw data ###################################
#         g ,b, r = cv2.split(rgb_np_resized)
#         rgb_np_resized_color = cv2.merge((r,g,b))
...
#         print ('dense_depth_img_np_resized_color_shape = ' , dense_depth_img_np_resized_color.shape)
        
#         plt.figure(figsize=(10, 10))
#         plt.imshow(dense_depth_img_np_resized_color.transpose(1,2,0) , cmap='magma')
#         plt.title("dense_depth_img_np_resized_color", fontsize=22)
#         plt.axis('off')

#         plt.figure(figsize=(10, 10))
#         plt.imshow(rgb_np_resized_color)
#         plt.title("rgb raw", fontsize=22)
#         plt.axis('off')
...
#         rgb_img = transforms.ToTensor()(rgb_np_resized_color)
...
#         corrs = self.trim_corrs(corrs) # random 2d point-cloud trim
        ...
        corrs_knn_idx = self.knn(corrs,200) # knn 2d point-cloud trim
...
#         corrs[:, 0] = (0.5*corrs[:, 0])/640
#         corrs[:, 1] = (1*corrs[:, 1])/192
#         corrs[:, 2] = (0.5*corrs[:, 2])/640 + 0.5        
#         corrs[:, 3] = (1*corrs[:, 3])/192
