...
#                 "load_weights_path" : './COTR/out/default/checkpoint.pth.tar' ,
                "load_weights_path" : '/root/work/COTR/out/model/20220324_1/106K_0.0004val_checkpoint.pth.tar' ,
...
#         self.depth_decoder.eval();
        ...
        self.fc1 = nn.Linear(400, 256) # select numer of corresepondence matching point * 2 shape[0]
