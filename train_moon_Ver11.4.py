...
from LCCNet_COTR_moon_Ver11_4 import LCCNet ,LCCNet_old,LCCNet_old1
...
def config():
    ...
    val_sequence = 7
    epochs = 500
    BASE_LEARNING_RATE = 6.25e-6 # 1e-4
    loss = 'combined'
    ...
    weights = './checkpoints/kitti/odom/val_seq_07/models/checkpoint_r20.00_t1.50_e146_1.809.tar'
    # weights = None
